...
import strategies.BinaryTreePrinter.PrintableNode;
 ...
 */
public class BTNode<K, V> implements PrintableNode {
	/**
	 * This mades BTNode comparable and therefore can be used to store them inside a SortedList
	 * 
	 * @author Maria A. Munoz-Valenzuela based on past projects 
	 *
	 * @param <K>
	 * @param <V>
	 */
	public static class ComparableKey<K extends Comparable<K>, V> extends BTNode<K, V> implements Comparable<BTNode<K, V>>{

		public ComparableKey(K key, V value) {
			super(key, value);
		}
